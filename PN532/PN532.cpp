...
bool PN532::powerDown() {
  ...
  pn532_packetbuffer[1] =
      0x10; //(0x10, for HSU) The wakeup source(s) you want too use
  pn532_packetbuffer[2] =
      0x00; // To eneable the IRQ, 0x00 if you dont want too use the IRQ
...
uint8_t PN532::mifareclassic_WriteNDEFURI(uint8_t sectorNumber,
  ...
  uint8_t sectorbuffer1[16] = {
      0x00,          0x00, 0x03, static_cast<uint8_t>(len + 5), 0xD1, 0x01, static_cast<uint8_t>(len + 1), 0x55,
